...
<body style="margin-left: 10px; text-align: center;">

        <h1 id='nname' style="margin-right: 10px;">
        <?php
            //connect and stuff
        ...
        <?php
            ...
            if ($subscribed) {
                print "<input id='startBtn' type = 'submit' name = 'subscribe' value = 'SUBSCRIBED' style='margin-right: 10px;'><br><br>";
            } else {
                print "<input id='startBtn2' type = 'submit' name = 'subscribe' value = 'SUBSCRIBE' style='margin-right: 10px;'><br><br>";
            }


            //prints out subscribers
            print "<a href='subs.php'><p style='margin-right: 10px;'>SUBS: " . $subscribers . "</p></a>";
            ...
            if ($r = mysql_query($query)) {
                while ($row = mysql_fetch_array($r)) {
                    ...
                    if (!empty($row['posts'])) {
                      ...
                      print "<p style='color: grey; float: right; margin-right: 15px; font-size: 12px;'>" . date_format($text_date, "M d, Y") . "</p>";
                      print "<p style='color: grey; float: left; margin-left: 15px; font-size: 12px;'>" . date_format($text_date, "g:i A") . "</p>";
