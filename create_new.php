...
<html>
    ...
    <body style="background-image: url(http://www.theyrjournal.com/wp-content/uploads/bb-plugin/cache/pexels-photo-30360-landscape.jpg); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;" align="center">
        ...
        <div style="background-color: #efefef; width: 500px; margin: 0 auto;" class="well" id="wellbox">

    <form action="create_new.php" method="post">
        <h3 class="user">Username</h3>
        <input style="text-align: center; margin: 0 auto;" type="text" name="username" id = 'inp' placeholder="Enter New Username" autofocus="autofocus">
        <br><br><h3 class="user">Email</h3>
        <input style="text-align: center; margin: 0 auto;" type="text" name="email" id = 'inp' placeholder="Enter your Email Address">
        <br><br><h3 class="user">Phone</h3>
        <input style="text-align: center;" type="text" name="phone_number" id = 'inp' placeholder="10-digit phone number">
        <br><br><h3 class="user">Password</h3>
        <input style="text-align: center; margin: 0 auto;" type="password" name="password" id = 'inp' placeholder="Enter your New Password">
        <br><br><h3 class = 'pass'>Confirm Password</h3>
        <input style="text-align: center; margin: 0 auto;" type="password" name="confirm" id = 'inp' placeholder="Retype your Password"><br>
        <br>
        <br>
        <h4 style="font-family: arial; text-align: center;"></input>Creating an account means agreeing to our</h4></p>
        ...
        <a href='about.html'><div style="background-color: #efefef; width: 500px; margin: 0 auto;" class="well" id="wellbox"><h3>About Plumebin</h3></div></a>
        </div>

        <br>

        <a href='index.php'><div style="background-color: #efefef; width: 500px; margin: 0 auto;" class="well" id="wellbox"><h3>Already have an account? Click here!</h3></div></a>
        </div>
...
if (isset($_POST['submit'])) {
    ...
    mysql_connect('localhost', 'blake', 'breath2017');;
